...
---@field run fun(args: table<string, any>, runargs: table<string, string>): string? Function that returns the command to run the already built project
---@field build_and_run fun(args: table<string, any>, runargs: table<string, RunargSpecifier>): string? Function that returns the command to build and run the project
...
---@field init fun() Function run for the specified language when the runner is initialized
