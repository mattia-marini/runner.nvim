...
---@field currFileDir fun(): string Current file dirname
---@field currFileName fun(): string Current file basename
---@field runargs fun(): table<string,string> The arguments provided by the user via :Runargs

local utils = require("runner.utils")

function M.currFile() return vim.api.nvim_buf_get_name(0) end

function M.currFileDir() return vim.fs.dirname(vim.api.nvim_buf_get_name(0)) end

function M.currFileName() return vim.fs.basename(vim.api.nvim_buf_get_name(0)) end
